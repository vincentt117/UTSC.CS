...
public abstract class Trip implements java.io.Serializable {
  ...
  /**
   * Returns the cost of the <code>Trip</code>.
   * 
   * @return the cost
   */
  ...
  public String toString() {
    return "Trip [departureTime=" + departureTime + ", arrivalTime=" + arrivalTime + ", origin="
        + origin + ", destination=" + destination + ", cost=" + cost + ", tripDuration="
        + tripDuration + "]";
  }
