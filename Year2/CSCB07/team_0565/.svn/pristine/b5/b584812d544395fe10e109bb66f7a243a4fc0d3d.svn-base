...
public class SearchFlights extends AppCompatActivity {
    ...
    public void displayFlights(View v) {
        Intent intentDisplay = new Intent(this, DisplaySearchedFlights.class);
        intentDisplay.putExtra("driver", driver);
        intentDisplay.putExtra("client", client);
        SimpleDateFormat generalDate = new SimpleDateFormat("yyyy-MM-dd HH:mm");
        try {
