...
public class Driver {
  ...
  static String serPath3 = System.getProperty("user.dir") + "/CSCB07Project/app/src/sampletests/flights5.ser";
  static String serPath4 = System.getProperty("user.dir") + "/CSCB07Project/app/src/sampletests/client5.ser";
...
//  }
  ...
  public static String getClient(String email) {
    ...
    return String.format("%s;%s;%s;%s;%s,%s", lastName, firstName, 
        email, address, ccNumber, date.format(expiryDate));
